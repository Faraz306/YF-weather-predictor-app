...
if predict:
    with st.spinner(f"Training Yamaan's AI Model specifically for {city}..."):
        ...
        # Find maximum temperature column
        ...
        # Lightweight models to prevent RAM limit crash
    ...
    # Moving prediction steps cleanly outside the data block
